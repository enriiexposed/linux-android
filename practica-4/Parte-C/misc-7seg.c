	...
	MODULE_DESCRIPTION("Misc Display7s Kernel Module SMPsave and Thread Safe - FDI-UCM");
	MODULE_AUTHOR("Enrique Rios");
	...
	*  Prototypes
	*/
	int display7s_open (struct inode *, struct file *);
	int display7s_release (struct inode *, struct file *);
